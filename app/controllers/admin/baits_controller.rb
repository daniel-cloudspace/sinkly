class Admin::BaitsController < ApplicationController
  # GET /admin/baits
  # GET /admin/baits.json
  def index
    @admin_baits = Admin::Bait.all
  ...
  def show
    @admin_bait = Admin::Bait.find(params[:id])
  ...
  def create
    @admin_bait = Admin::Bait.new(params[:admin_bait])
